...
const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: 'wx56abd0b31b23ff1a',

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: '1f4b6d290dcce58be991665fc587de72',
  ...
  USERS: [
    {
      ...
      id: 'oCAz56SlQ-ZfHPruewqrQTAn7jCI',
      // 你想对他发送的模板消息的模板ID
      useTemplateId: 'PZ3FfjpxWqD67veUMvGZYqr0fauLWmdfPcPGgiUTZiI',
      // 所在省份
      province: '广东',
      // 所在城市
      city: '佛山',
      ...
      festivals: [
        ...
        {
          type: '生日', name: '宝贝', year: '2004', date: '05-03',
        },
        {
          type: '节日', name: '恋爱纪念日', year: '2022', date: '08-04',
        },
        // 注意：此条配置日期为阳历日期，因为`type`中 “生日” 之前没有 * 符号
        {
          type: '节日', name: '恋爱纪念日', year: '2022', date: '09-01',
        }
      ],
  ...
  CALLBACK_TEMPLATE_ID: 'PZ3FfjpxWqD67veUMvGZYqr0fauLWmdfPcPGgiUTZiI',
